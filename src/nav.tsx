                ...
                <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
                    ...
                    <nav>
                        ...
                        <div className="grid grid-flow-col gap-4">
                            <a href="https://youtube.gaminglounge.me/" target="_blank"><svg width="30" height="30" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg" style={{ fill: "red" }}>
                                <path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path>
                            </svg></a>
                            <a href="https://tiktok.gaminglounge.me/" target="_blank"><svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ fill: "black" }}>
                                <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 0 1 3.183-4.51v-3.5a6.329 6.329 0 0 0-5.394 10.692 6.33 6.33 0 0 0 10.857-4.424V8.687a8.182 8.182 0 0 0 4.773 1.526V6.79a4.831 4.831 0 0 1-1.003-.104z" />
                            </svg></a>
                            <a href="https://discord.gaminglounge.me/" target="_blank"><svg width="30" height="30" viewBox="0 -28.5 256 256" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://github.gaminglounge.me/" target="_blank"><svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ fill: "#24292f" }}>
